<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <router-link :to="{name: 'home'}" class="navbar-brand">Dr Social Spot</router-link>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ml-auto" v-if="$auth.check()">
        <li class="nav-item">
          <a class="nav-link" href="#" @click.prevent="redirectToNewsfeed()">Newsfeed</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#" @click.prevent="redirectToProfile()">Profile</a>
        </li>
        <li class="nav-item">
